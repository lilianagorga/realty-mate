...
describe('About Component', () => {
  ...
  test('renders the Heading component with correct title and subtitle', async () => {
    await act(async () => {
      render(
        <ChakraProvider theme={theme}>
          <BrowserRouter>
  ...
  test('renders the paragraphs with correct text', async () => {
    await act(async () => {
      render(
        <ChakraProvider theme={theme}>
          <BrowserRouter>
  ...
  test('renders the "More About Us" button', async () => {
    await act(async () => {
      render(
        <ChakraProvider theme={theme}>
          <BrowserRouter>
  ...
  test('renders the image with correct background style', async () => {
    await act(async () => {
      render(
        <ChakraProvider theme={theme}>
          <BrowserRouter>
  ...
  test('renders the Testimonials component', async () => {
    await act(async () => {
      render(
        <ChakraProvider theme={theme}>
          <BrowserRouter>
